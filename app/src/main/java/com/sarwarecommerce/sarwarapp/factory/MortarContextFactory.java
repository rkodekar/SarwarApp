package com.sarwarecommerce.sarwarapp.factory;

import android.content.Context;
import android.content.ContextWrapper;
import android.view.LayoutInflater;

import com.sarwarecommerce.sarwarapp.scope.PathScoper;
...
public final class MortarContextFactory implements PathContextFactory {
    ...
    @Override public Context setUpContext(Path path, Context parentContext) {
        MortarScope pathScope = pathScoper.getPathScope(parentContext, path.getClass().getName(), path);
